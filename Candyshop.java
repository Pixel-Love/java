...
public class Candyshop {
    ...
    public static ArrayList repairSweetList(ArrayList<Object> sweets){
        int fal = sweets.indexOf(false);
        sweets.remove(false);
        sweets.add(fal, "Ice cream");
        int ketto = sweets.indexOf(2);
        sweets.remove(ketto);
        sweets.add(ketto, "Croissant");
        return sweets;
    }
